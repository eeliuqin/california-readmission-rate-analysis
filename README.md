...
* [Obtaining the Data](#step-1-obtaining-the-data)
* [Data Cleaning and Manipulation](#step-2-data-cleaning-and-manipulation)
* [Analyze](#analyze)
* [Conclusion and Recommendation](#conclusion-and-recommendation)

## Introduction
According to the [Agency for Healthcare Research and Quality (AHRQ)](https://www.hcup-us.ahrq.gov/reports/statbriefs/sb278-Conditions-Frequent-Readmissions-By-Payer-2018.jsp), there were 3.8 million 30-day all-cause adult readmissions in 2018, with a readmission rate of 14%, and an average readmission cost of $15,200. For patients, high readmission rates not only increase their costs, but also indicate that the quality of care they receive is poor. For hospitals, high readmission rates not only create an administrative burden, but can also lead to [Hospital Readmission Reduction Program (HRRP)](https://www.cms.gov/Medicare/Medicare-Fee-for-Service-Payment/AcuteInpatientPPS/Readmissions-Reduction-Program) penalties. Therefore, reducing readmission rates has long been a health policy goal to improve the quality of care.
...
We are going to find out how readmission rates are associated with: age of patients, race/ethnicity of patients, payer type, county, population to LTC (Long Term Care) type facility ratio, and population to FDR (First Tier, Downstream, and Related Entities defined by [CMS](https://www.cms.gov/)) type facility ratio.
...
**Recommendation**:
- Further research is needed to explore whether certain demographics groups and low FDR facility ratios are causally related with high readmission rates.
- A case study of Butte County is needed to identify the root cause of its persistently high readmission rates.
